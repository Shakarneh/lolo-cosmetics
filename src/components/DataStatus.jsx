function DataStatus({ error, onRetry }) {
  return (
    <section className="mx-auto max-w-6xl px-4 py-24 flex flex-col items-center gap-4 text-center">
      {error ? (
        <>
          <span className="text-5xl">⚠️</span>
          <p className="text-xl font-medium text-charcoal">تعذّر تحميل المنتجات</p>
        ...
        <>
          ...
          <p className="text-lg text-taupe">جاري تحميل المنتجات...</p>
        </>
      )}
    </section>
  )
